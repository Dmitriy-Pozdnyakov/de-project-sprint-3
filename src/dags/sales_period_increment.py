...
def upload_data_to_staging(filename, date, pg_table, pg_schema, ti):
    ...
    psql_connect_setting = f"dbname='de' port='{psql_conn.port}' user='{psql_conn.login}' host='{psql_conn.host}' password='{psql_conn.password}'"

    conn = psycopg2.connect(psql_connect_setting)
    cur = conn.cursor()
...
with DAG(
        'sales_mart_period_increment',
        default_args=args,
        description='sales mart period increment dag for sprint3',
        catchup=True,
